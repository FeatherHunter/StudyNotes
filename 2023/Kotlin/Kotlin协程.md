...
```kotlin
CoroutineScheduler$Worker (kotlinx.coroutines.scheduling)
->run():664,
 ->runWorker:677,
   ->executeTask:750,
CoroutineScheduler
   ->runSafely:570, // Task[LimitedDispatcher@21da8ac, 75146667024900, kotlinx.coroutines.scheduling.TaskContextImpl@558246b6]
TaskImpl (kotlinx.coroutines.scheduling)
   ->run:95, 
LimitedDispatcher (kotlinx.coroutines.internal) 
   ->run:42, // CancellableContinuation(DispatchedContinuation[Dispatchers.IO, Continuation at com.derry.kt_coroutines.t93.MyKtKt.query(MyKt.kt:45)@32414695]){Completed}@6595f346
DispatchedTask(kotlinx.coroutines)
   ->run:88, 
    ->withContinuationContext:116,
     ->continuation.resume(getSuccessfulResult(state)) // Continuation at com.derry.kt_coroutines.t93.MyKtKt.query(MyKt.kt:45)
