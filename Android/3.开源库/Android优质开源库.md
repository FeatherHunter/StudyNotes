...
2. [Android开源库和资料汇总](http://blog.csdn.net/wu996489865/article/details/53585433)

阿里巴巴、百度等公司开源库：http://blog.csdn.net/wh211212/article/details/70147572

Yalantis 酷炫开源UI项目: http://blog.csdn.net/u013812939/article/details/45718431
...
##公司开源库
###Google
https://www.cnblogs.com/svili/p/7889436.html
1. glide
2. zxing：二维码
3. Dagger2：https://www.jianshu.com/p/39d1df6c877d
4. gson
5. Flutter
6. Volley
7. ExoPalyer
...
>Google 开源了一个 Android 架构的官方指导，涉及 mvp、mvp-loaders、databinding、mvp-clean、mvp-dagger、mvp-contentproviders、mvp-rxjava 等，分别在各自指定的分支下，有非常大的参考意义，可以算是 Android 界的一大步。

###Square
1、okio
>不像Java的输入输出流那样复杂啰嗦，尤其擅长支持二进制数据。

2、okhttp
>Http请求库

3、retrofit
>Square 是最早开源项目之一， Retrofit是目前 Android 最流行的 Http Client 库之一

4、Picasson
>图片缓存库- picasso 功能单一，没有缓存过期，同androidQuery一样链式调用，载入本地文件速度慢。作者：JakeWharton
...
7、Otto
>一个事件库 (pub/sub 模式)， 用来简化应用程序组件之间的通讯， otto 修改自Google 的 Guava 库， 专门为 Android 平台进行了优化， 与上面介绍的 EventBus 相比， 两个库各有各的优点，完全取决于我们自己项目的需求来选择它们哪一个

9、android-times-square
>TimesSquare 是 Square 公司出品的一款显示日历选择日期的控件， 可以让用户选择多个日期

###Facebook
http://blog.csdn.net/hyugahinat/article/details/50949084

1、Fresco
>Fresco 是一个强大的图片加载组件， 支持加载 Gif 图和 WebP 格式， 支持 Android2.3(API level 9) 及其以上系统

2、React Native


3、Stetho
>一个强大的 Android 调试工具，使用该工具你可以在 ChromeDeveloper Tools 查看 App 的布局， 网络请求(仅限使用 Volley， okhttp 的网络请求库)， sqlite,preference, 一切都是可视化的操作，无须自己在去使用 adb, 也不需要 root 你的设备

4、Rebound
>Facebook弹性动画库, 可以让动画看起来真实自然， 像真实世界的物理运动， 带有力的效果， 使用的参数则是 Facebook 的 origami 中使用的
...
1. ContextMenu
动画体验很棒的 Context Menu
Android 版：https://github.com/Yalantis/Context-Menu.Android
iOS 版：https://github.com/Yalantis/Context-Menu.iOS


2. Side Menu
动画体验很棒的 Side Menu
Android 版：https://github.com/Yalantis/Side-Menu.Android
iOS 版：https://github.com/Yalantis/Side-Menu.iOS


3. Phoenix
下拉刷新，带 Header 渐渐凸显效果
Android 版：https://github.com/Yalantis/Phoenix
iOS 版：https://github.com/Yalantis/Pull-to-Refresh.Rentals-iOS


4. Taurus
另一种下拉刷新效果
Android 版：https://github.com/Yalantis/Taurus


5. FlipViewPager.Draco
提供 ListView Item 翻页效果
Android 版：https://github.com/Yalantis/FlipViewPager.Draco


6. FoldingTabBar
可展开收缩的 TabBar
iOS 版：https://github.com/Yalantis/FoldingTabBar.iOS


7. CameraModule
简单的 Android 拍照模块
GitHub：https://github.com/Yalantis/CameraModule


8. Euclid
这个项目目前还只是不错的动画跳转效果 Demo
Android 版：https://github.com/Yalantis/Euclid
...
2、Hugo
>JakeWharton 大神推出的一个用于打印 Log, hugo 是基于注解被调用的， 引入相关依赖后， 在方法上加上 @DebugLog 即可输出 Log, 使用非常简单
...
###开发工具库
AndroidUtilsCode: https://www.jianshu.com/p/677856023d0c

github: 最常见开源库汇总-http://blog.csdn.net/wu996489865/article/details/53585433

包含IOS和Android的优秀开源网站，可以学习学习：http://appxcode.com/index.php?con=index&act=category&cid=5
